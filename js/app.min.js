...
"use strict";function getPointGeoJson(o){var t=new XMLHttpRequest;t.open("GET",o,!0),t.onload=function(){if(t.status>=200&&t.status<400){var o=JSON.parse(t.responseText);L.geoJson(o,{pointToLayer:function(o,t){var e=L.marker(t,{icon:myIcon});return e.bindPopup(o.properties.Location+"<br/>"+o.properties.Date+'<br/><a href="'+o.properties.Link+'" target="_blank">Read the story &raquo;</a>'),e}}).addTo(map)}},t.onerror=function(){},t.send()}function getShapeGeoJson(o){var t=new XMLHttpRequest;t.open("GET",o,!0),t.onload=function(){if(t.status>=200&&t.status<400){var o=JSON.parse(t.responseText);L.geoJson(o,{style:commStyle}).addTo(map)}},t.onerror=function(){},t.send()}var $=require("jQuery"),myIcon=L.divIcon({className:"shooting-icon"}),commStyle={fillColor:"#FFF",color:"#222222",weight:3,opacity:.5},map=L.map("map",{scrollWheelZoom:!1}).setView([41.838299,-87.706953],11);L.tileLayer("http://{s}.tribapps.com/chicago-print/{z}/{x}/{y}.png",{subdomains:["maps1"],attribution:'Map data &copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors',maxZoom:16,minZoom:10}).addTo(map),L.tileLayer("http://media.apps.chicagotribune.com/maptiles/chicago-mask/{z}/{x}/{y}.png",{maxZoom:16,minZoom:10,opacity:.5}).addTo(map),getPointGeoJson("http://"+window.ROOT_URL+"/data/locations.geojson"),getShapeGeoJson("http://"+window.ROOT_URL+"/data/commareas.geojson");
